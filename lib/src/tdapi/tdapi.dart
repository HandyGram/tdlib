...
TdObject? convertToObject(String? query) {
  ...
  switch (newJson['@type']) {
    ...
    case 'authenticationCodeTypeFirebaseAndroid': return AuthenticationCodeTypeFirebaseAndroid.fromJson(newJson);
    case 'authenticationCodeTypeFirebaseIos': return AuthenticationCodeTypeFirebaseIos.fromJson(newJson);
    ...
    case 'emailAddressResetStateAvailable': return EmailAddressResetStateAvailable.fromJson(newJson);
    case 'emailAddressResetStatePending': return EmailAddressResetStatePending.fromJson(newJson);
    ...
    case 'webApp': return WebApp.fromJson(newJson);
    ...
    case 'chatBackground': return ChatBackground.fromJson(newJson);
    ...
    case 'accessHashTypeUser': return AccessHashTypeUser.fromJson(newJson);
    case 'accessHashTypeChannel': return AccessHashTypeChannel.fromJson(newJson);
    case 'accessHash': return AccessHash.fromJson(newJson);
    ...
    case 'chatPhotoStickerTypeRegularOrMask': return ChatPhotoStickerTypeRegularOrMask.fromJson(newJson);
    case 'chatPhotoStickerTypeCustomEmoji': return ChatPhotoStickerTypeCustomEmoji.fromJson(newJson);
    case 'chatPhotoSticker': return ChatPhotoSticker.fromJson(newJson);
    ...
    case 'inputChatPhotoSticker': return InputChatPhotoSticker.fromJson(newJson);
    ...
    case 'premiumStatePaymentOption': return PremiumStatePaymentOption.fromJson(newJson);
    ...
    case 'messageViewer': return MessageViewer.fromJson(newJson);
    case 'messageViewers': return MessageViewers.fromJson(newJson);
    ...
    case 'messageSourceChatHistory': return MessageSourceChatHistory.fromJson(newJson);
    case 'messageSourceMessageThreadHistory': return MessageSourceMessageThreadHistory.fromJson(newJson);
    case 'messageSourceForumTopicHistory': return MessageSourceForumTopicHistory.fromJson(newJson);
    case 'messageSourceHistoryPreview': return MessageSourceHistoryPreview.fromJson(newJson);
    case 'messageSourceChatList': return MessageSourceChatList.fromJson(newJson);
    case 'messageSourceSearch': return MessageSourceSearch.fromJson(newJson);
    case 'messageSourceChatEventLog': return MessageSourceChatEventLog.fromJson(newJson);
    case 'messageSourceNotification': return MessageSourceNotification.fromJson(newJson);
    case 'messageSourceOther': return MessageSourceOther.fromJson(newJson);
    ...
    case 'chatFolderIcon': return ChatFolderIcon.fromJson(newJson);
    case 'chatFolder': return ChatFolder.fromJson(newJson);
    case 'chatFolderInfo': return ChatFolderInfo.fromJson(newJson);
    case 'chatFolderInviteLink': return ChatFolderInviteLink.fromJson(newJson);
    case 'chatFolderInviteLinks': return ChatFolderInviteLinks.fromJson(newJson);
    case 'chatFolderInviteLinkInfo': return ChatFolderInviteLinkInfo.fromJson(newJson);
    case 'recommendedChatFolder': return RecommendedChatFolder.fromJson(newJson);
    case 'recommendedChatFolders': return RecommendedChatFolders.fromJson(newJson);
    case 'chatListMain': return ChatListMain.fromJson(newJson);
    case 'chatListArchive': return ChatListArchive.fromJson(newJson);
    case 'chatListFolder': return ChatListFolder.fromJson(newJson);
    ...
    case 'keyboardButtonTypeRequestUser': return KeyboardButtonTypeRequestUser.fromJson(newJson);
    case 'keyboardButtonTypeRequestChat': return KeyboardButtonTypeRequestChat.fromJson(newJson);
    ...
    case 'foundWebApp': return FoundWebApp.fromJson(newJson);
    ...
    case 'messageChatSetBackground': return MessageChatSetBackground.fromJson(newJson);
    ...
    case 'messageUserShared': return MessageUserShared.fromJson(newJson);
    case 'messageChatShared': return MessageChatShared.fromJson(newJson);
    ...
    case 'emojiCategory': return EmojiCategory.fromJson(newJson);
    case 'emojiCategories': return EmojiCategories.fromJson(newJson);
    case 'emojiCategoryTypeDefault': return EmojiCategoryTypeDefault.fromJson(newJson);
    case 'emojiCategoryTypeEmojiStatus': return EmojiCategoryTypeEmojiStatus.fromJson(newJson);
    case 'emojiCategoryTypeChatPhoto': return EmojiCategoryTypeChatPhoto.fromJson(newJson);
    ...
    case 'firebaseAuthenticationSettingsAndroid': return FirebaseAuthenticationSettingsAndroid.fromJson(newJson);
    case 'firebaseAuthenticationSettingsIos': return FirebaseAuthenticationSettingsIos.fromJson(newJson);
    ...
    case 'inlineQueryResultsButtonTypeStartBot': return InlineQueryResultsButtonTypeStartBot.fromJson(newJson);
    case 'inlineQueryResultsButtonTypeWebApp': return InlineQueryResultsButtonTypeWebApp.fromJson(newJson);
    case 'inlineQueryResultsButton': return InlineQueryResultsButton.fromJson(newJson);
    ...
    case 'premiumLimitTypeChatFolderCount': return PremiumLimitTypeChatFolderCount.fromJson(newJson);
    case 'premiumLimitTypeChatFolderChosenChatCount': return PremiumLimitTypeChatFolderChosenChatCount.fromJson(newJson);
    ...
    case 'premiumLimitTypeChatFolderInviteLinkCount': return PremiumLimitTypeChatFolderInviteLinkCount.fromJson(newJson);
    case 'premiumLimitTypeShareableChatFolderCount': return PremiumLimitTypeShareableChatFolderCount.fromJson(newJson);
    ...
    case 'premiumFeatureRealTimeChatTranslation': return PremiumFeatureRealTimeChatTranslation.fromJson(newJson);
    ...
    case 'deviceTokenHuaweiPush': return DeviceTokenHuaweiPush.fromJson(newJson);
    ...
    case 'inputBackgroundPrevious': return InputBackgroundPrevious.fromJson(newJson);
    ...
    case 'pushMessageContentChatSetBackground': return PushMessageContentChatSetBackground.fromJson(newJson);
    ...
    case 'internalLinkTypeChatFolderInvite': return InternalLinkTypeChatFolderInvite.fromJson(newJson);
    case 'internalLinkTypeChatFolderSettings': return InternalLinkTypeChatFolderSettings.fromJson(newJson);
    ...
    case 'internalLinkTypeWebApp': return InternalLinkTypeWebApp.fromJson(newJson);
    ...
    case 'memoryStatistics': return MemoryStatistics.fromJson(newJson);
    ...
    case 'autosaveSettingsScopePrivateChats': return AutosaveSettingsScopePrivateChats.fromJson(newJson);
    case 'autosaveSettingsScopeGroupChats': return AutosaveSettingsScopeGroupChats.fromJson(newJson);
    case 'autosaveSettingsScopeChannelChats': return AutosaveSettingsScopeChannelChats.fromJson(newJson);
    case 'autosaveSettingsScopeChat': return AutosaveSettingsScopeChat.fromJson(newJson);
    case 'scopeAutosaveSettings': return ScopeAutosaveSettings.fromJson(newJson);
    case 'autosaveSettingsException': return AutosaveSettingsException.fromJson(newJson);
    case 'autosaveSettings': return AutosaveSettings.fromJson(newJson);
    ...
    case 'suggestedActionUpgradePremium': return SuggestedActionUpgradePremium.fromJson(newJson);
    case 'suggestedActionSubscribeToAnnualPremium': return SuggestedActionSubscribeToAnnualPremium.fromJson(newJson);
    ...
    case 'updateChatBackground': return UpdateChatBackground.fromJson(newJson);
    ...
    case 'updateChatIsTranslatable': return UpdateChatIsTranslatable.fromJson(newJson);
    ...
    case 'updateChatFolders': return UpdateChatFolders.fromJson(newJson);
    ...
    case 'updateAccessHash': return UpdateAccessHash.fromJson(newJson);
    ...
    case 'updateAddChatMembersPrivacyForbidden': return UpdateAddChatMembersPrivacyForbidden.fromJson(newJson);
    case 'updateAutosaveSettings': return UpdateAutosaveSettings.fromJson(newJson);
